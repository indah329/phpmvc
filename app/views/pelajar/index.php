  ...
  <ul class="list-group">
    <?php foreach ($data['plj'] as $plj) : ?>
      <li class="list-group-item">
        ...
        <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $plj['id']; ?>" class="badge bg-warning float-end me-1 tampilModalUbah" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?=$plj['id']?>">ubah</a>
